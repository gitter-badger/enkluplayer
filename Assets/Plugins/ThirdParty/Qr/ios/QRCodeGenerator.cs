    ...
    public class QRCodeGenerator : IDisposable
    {
        ...
        private struct CodewordBlock
        {
            public CodewordBlock(int groupNumber, int blockNumber, string bitString, List<string> codeWords,
                List<string> eccWords, List<int> codeWordsInt, List<int> eccWordsInt) : this()
            {
        ...
        private struct ECCInfo
        {
            public ECCInfo(int version, ECCLevel errorCorrectionLevel, int totalDataCodewords, int eccPerBlock, int blocksInGroup1,
                int codewordsInGroup1, int blocksInGroup2, int codewordsInGroup2) : this()
            {
        ...
        {
            public VersionInfo(int version, List<VersionInfoDetails> versionInfoDetails) : this()
            {
                this.Version = version;
        ...
        {
            public VersionInfoDetails(ECCLevel errorCorrectionLevel, Dictionary<EncodingMode, int> capacityDict) : this()
            {
                this.ErrorCorrectionLevel = errorCorrectionLevel;
        ...
        {
            public Antilog(int exponentAlpha, int integerValue) : this()
            {
        ...
        {
            public PolynomItem(int coefficient, int exponent) : this()
            {
