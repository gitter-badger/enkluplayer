...
namespace CreateAR.Commons.Unity.Http
{
    ...
    public class UwpHttpService : IHttpService
    {
        ...
        /// 
        /// TODO: This class enforces a json content-type, but accepts any
        /// TODO: ISerializer.
        /// </summary>
            ...
            object payload)
        {
            ...
            OnRequest?.Invoke(verb.ToString(), url, new Dictionary<string, string>(), payload);
            ...
            ref byte[] file)
        {
            ...
            OnRequest?.Invoke(verb.ToString(), url, new Dictionary<string, string>(), file);
