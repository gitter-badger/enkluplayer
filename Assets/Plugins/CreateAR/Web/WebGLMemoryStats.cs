...
namespace CreateAR.SpirePlayer
{
    ...
    /// Taken from:
    /// 
    /// https://raw.githubusercontent.com/kongregate/Unity-WebGL-Utilities/master/Assets/Plugins/WebGLMemoryStats/WebGLMemoryStats.cs
    /// </summary>
    public class WebGLMemoryStats : MonoBehaviour
    {
        ...
        private void Log() {
            ...
            Commons.Unity.Logging.Log.Info(this, "WebGL Memory - Total: {0}MB, Used: {1}MB, Free: {2}MB", total, used, free);
        }
