    ...
    public class JsValue : IEquatable<JsValue>
    {
        ...
        public static JsValue FromObject(Engine engine, object value)
        {
            ...
            if (instance != null)
            {
                ...
                var dict = new Dictionary<Type, Func<Engine, object, JsValue>>(typeMappers);
                dict[valueType] = (e, v) => new JsValue((ObjectInstance) v);
                Interlocked.CompareExchange(
                    ref Engine.TypeMappers,
                    dict,
                    typeMappers);
