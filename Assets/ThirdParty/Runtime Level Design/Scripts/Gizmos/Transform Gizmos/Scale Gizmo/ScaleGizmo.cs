...
namespace RLD
{
    ...
    public class ScaleGizmo : GizmoBehaviour
    {
        ...
        public override void OnAttached()
        {
            ...
            _negXSlider = new GizmoLineSlider3D(Gizmo, GizmoHandleId.NXSlider, GizmoHandleId.PYCap);
            ...
            _pstvYSlider = new GizmoLineSlider3D(Gizmo, GizmoHandleId.PYSlider, GizmoHandleId.PZCap);
            ...
            _negYSlider = new GizmoLineSlider3D(Gizmo, GizmoHandleId.NYSlider, GizmoHandleId.NXCap);
            ...
            _pstvZSlider = new GizmoLineSlider3D(Gizmo, GizmoHandleId.PZSlider, GizmoHandleId.NYCap);
