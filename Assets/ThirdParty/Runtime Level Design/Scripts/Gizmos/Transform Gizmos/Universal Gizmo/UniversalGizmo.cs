...
namespace RLD
{
    ...
    public class UniversalGizmo : GizmoBehaviour
    {
        ...
        public override void OnAttached()
        {
            ...
            _mvNXSlider = new GizmoLineSlider3D(Gizmo, GizmoHandleId.NXSlider, GizmoHandleId.PYCap);
            _mvNXSlider.SetDragChannel(GizmoDragChannel.Offset);
            _mvNXSlider.MapDirection(0, AxisSign.Negative);

            _mvPYSlider = new GizmoLineSlider3D(Gizmo, GizmoHandleId.PYSlider, GizmoHandleId.PZCap);
            _mvPYSlider.SetDragChannel(GizmoDragChannel.Offset);
            _mvPYSlider.MapDirection(1, AxisSign.Positive);

            _mvNYSlider = new GizmoLineSlider3D(Gizmo, GizmoHandleId.NYSlider, GizmoHandleId.NXCap);
            _mvNYSlider.SetDragChannel(GizmoDragChannel.Offset);
            _mvNYSlider.MapDirection(1, AxisSign.Negative);

            _mvPZSlider = new GizmoLineSlider3D(Gizmo, GizmoHandleId.PZSlider, GizmoHandleId.NYCap);
