...
namespace RLD
{
    public class RLDApp : MonoSingleton<RLDApp>, IRLDApplication
    {
        ...
        public static void Initialize()
        {
            ...
            scene.LookAndFeel.LightIcon = Resources.Load("Textures/LightBulb") as Texture2D;
            scene.LookAndFeel.ParticleSystemIcon = Resources.Load("Textures/ParticleSystem") as Texture2D;
