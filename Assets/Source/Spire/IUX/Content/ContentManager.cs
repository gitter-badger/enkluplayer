...
namespace CreateAR.SpirePlayer
{
    ...
    public class ContentManager : IContentManager
    {
        ...
        private class ContentRecord
        {
            ...
            /// Content instance.
            /// </summary>
            public readonly ContentWidget Content;
            ...
            public ContentRecord(ContentWidget content)
            {
                Id = content.Data.Id;
                Content = content;
            }
        ...
        public void FindAll(string contentId, List<ContentWidget> content)
        {
        ...
        /// <inheritdoc cref="IContentManager"/>
        public ContentWidget FindShared(string contentId)
        {
        ...
        /// <inheritdoc cref="IContentManager"/>
        public ContentWidget Request(string contentId, params string[] tags)
        {
        ...
        /// <inheritdoc cref="IContentManager"/>
        public void Release(ContentWidget content)
        {
        ...
        /// <returns></returns>
        private ContentWidget RequestUnique(ContentData data, params string[] tags)
        {
        ...
        /// <param name="tags">Tags with which to tag the <c>Content</c> for later cleanup.</param>
        /// <returns></returns>
        private ContentWidget RequestShared(ContentData data, params string[] tags)
        {
