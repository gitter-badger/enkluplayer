...
namespace CreateAR.SpirePlayer
{
    ...
    public interface IContentManager
    {
        ...
        void FindAll(string contentId, List<ContentWiget> content);
        ...
        /// <returns></returns>
        ContentWiget FindShared(string contentId);
        ...
        /// <returns></returns>
        ContentWiget Request(string contentId, params string[] tags);
        ...
        void Release(ContentWiget content);
