...
namespace CreateAR.SpirePlayer.Test.UI
{
    ...
    public class Element_IntegrationTests
    {
        ...
        public void Setup()
        {
            _factory = new ElementFactory(new DummyElementManager(), new PassthroughGizmoManager(), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        }
